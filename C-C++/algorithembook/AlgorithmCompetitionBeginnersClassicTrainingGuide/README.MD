...
* 问题3 硬币问题。有n种硬币，面值分别为V<sub>1</sub>,V<sub>2</sub>,...,V<sub>n</sub>，每种都有无限多。给定非负整数S,可以选用多少个硬币，使得面值i值和恰好为S？输出硬币数目的最小值和最大值。其中,1<=n<=100,0<=S<=10000,1<=V<sub>i</sub><=S。 $\leqslant $
